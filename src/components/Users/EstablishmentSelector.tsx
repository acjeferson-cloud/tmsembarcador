    ...
    <div className="space-y-4">
      ...
      <div className="p-4 bg-blue-50 rounded-lg">
        <div className="flex items-start space-x-2">
          ...
          <div>
            <p className="text-sm text-blue-800 font-medium">Estabelecimentos do Usuário</p>
            <p className="text-xs text-blue-700 mt-1">
              Selecione os estabelecimentos que este usuário poderá acessar. Após o login, o usuário deverá selecionar
              um dos estabelecimentos permitidos para iniciar o trabalho.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden max-h-96 overflow-y-auto">
        <div className="bg-gray-50 dark:bg-gray-900 px-4 py-3 border-b border-gray-200 dark:border-gray-700 sticky top-0">
          <div className="grid grid-cols-12 gap-4">
            <div className="col-span-8 font-medium text-gray-700 dark:text-gray-300">Estabelecimento</div>
            <div className="col-span-4 font-medium text-gray-700 dark:text-gray-300">Acesso</div>
          </div>
        </div>
                  ...
                  <div className="grid grid-cols-12 gap-4 items-center">
                    ...
                    <div className="col-span-4">
                      ...
                      >
                        ...
                        <span className="ml-2">
                          {localEstablishments.includes(establishment.codigo) ? 'Permitido' : 'Não permitido'}
                        </span>
                      </button>
                    </div>
                  </div>
      ...
      <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg">
        <div className="flex items-center justify-between">
          <span className="text-sm text-gray-700 dark:text-gray-300">
            {localEstablishments.length} estabelecimento(s) selecionado(s)
          </span>
          <span className="text-sm text-gray-700 dark:text-gray-300">
