  ...
  const handleCreatePickups = async () => {
    ...
    try {
      ...
      if (result.success && result.pickups) {
        ...
        setError(result.error || t('invoices.modals.createPickup.errorCreate'));
      }
    } catch (err: any) {
      setError(err.message || t('invoices.modals.createPickup.errorProcess'));
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border border-blue-200 dark:border-blue-800">
                ...
                <div className="grid grid-cols-4 gap-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <Package className="w-4 h-4 text-blue-600 dark:text-blue-400" />
                    <div>
                      <p className="text-xs text-blue-600 dark:text-blue-400">{t('invoices.modals.common.cubicMeters')}</p>
                      <p className="text-lg font-bold text-blue-900 dark:text-blue-300">
              ...
              <div className="flex space-x-3 pt-4 border-t border-gray-200 dark:border-gray-700 mt-4">
                ...
                >
                  <Package size={20} />
                  <span>{isLoading ? t('invoices.modals.common.processing') : t('invoices.modals.createPickup.confirmBtn')}</span>
                </button>
                <button
                  onClick={handleClose}
