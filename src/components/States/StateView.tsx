...
import { ArrowLeft, Edit, MapPin, Building, Hash, Globe } from 'lucide-react';
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          <div className="flex items-start space-x-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 mb-4">Código IBGE: {state.ibgeCode || (state as any).ibge_code}</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium text-gray-900 dark:text-white">{state.ibgeCode || (state as any).ibge_code}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-4 bg-blue-50 rounded-lg">
              ...
              <p className="text-sm text-blue-700">Sigla</p>
            </div>
            <div className="text-center p-4 bg-green-50 rounded-lg">
              <p className="text-2xl font-bold text-green-600">{state.ibgeCode || (state as any).ibge_code}</p>
              <p className="text-sm text-green-700">Código IBGE</p>
            </div>
