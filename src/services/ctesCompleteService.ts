      ...
      let query = (supabase as any)
        ...
        .select(`
          *,
          ...
          carrier:carriers(id, codigo, razao_social, cnpj, metadata, sap_cardcode, sap_bpl_id, sap_due_days, contacts:carrier_contacts(name, email, phone, contact_types, is_primary)),
