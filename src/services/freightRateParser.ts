  ...
  normalizedFlatData.forEach((row, index) => {
    ...
    if (!ratesMap.has(rateKey)) {
      ...
      ratesMap.set(rateKey, {
        ...
        coleta_franquia_kg: parseNumber(row.coleta_franquia_kg),
        coleta_excedente_kg: parseNumber(row.coleta_excedente_kg),
        taxa_entrega: parseNumber(row.taxa_entrega),
        entrega_franquia_kg: parseNumber(row.entrega_franquia_kg),
        entrega_excedente_kg: parseNumber(row.entrega_excedente_kg),
