-- Atualiza a RPC save_erp_integration_config para suportar sap_fetch_drafts
...
BEGIN
    ...
    IF v_existing_id IS NOT NULL THEN
        UPDATE public.erp_integration_config SET
            ...
            sap_fetch_drafts = COALESCE((p_payload->>'sap_fetch_drafts')::BOOLEAN, false),
    ...
    ELSE
        INSERT INTO public.erp_integration_config (
            ...
            COALESCE((p_payload->>'sap_fetch_drafts')::BOOLEAN, false),
