-- Adicionando a coluna invoice_default_item
ALTER TABLE public.erp_integration_config ADD COLUMN IF NOT EXISTS invoice_default_item VARCHAR(255);

-- Atualização da Função RPC para suportar a nova coluna invoice_default_item
