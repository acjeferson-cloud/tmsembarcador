/*
  # Corrigir ambiguidade de colunas na função get_orders_prioritized
  
  1. Problema
    - ERROR: column reference "organization_id" is ambiguous
    - Variáveis locais têm o mesmo nome das colunas da tabela
    - SQL não consegue diferenciar entre v_user_org_id e o.organization_id
  
  2. Solução
    - Recriar função usando aliases claros
    - Qualificar todas as colunas com alias da tabela (o.)
    - Usar COALESCE corretamente
...
-- Recriar função com aliases corretos
