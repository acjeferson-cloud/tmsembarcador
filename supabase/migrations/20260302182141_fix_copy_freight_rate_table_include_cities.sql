/*
  # Corrigir função copy_freight_rate_table para incluir cidades

  1. Alterações
    - Adicionar cópia de freight_rate_cities
    - Manter todos os relacionamentos entre tabelas, tarifas e cidades
    - Retornar contadores de cities_copied
*/
...
'Copia uma tabela de frete completa incluindo todas as tarifas, detalhes e cidades. Mantém isolamento multi-tenant (organization_id e environment_id).';