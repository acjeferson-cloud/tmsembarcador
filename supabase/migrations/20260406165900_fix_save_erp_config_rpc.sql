-- Corrige a RPC save_erp_integration_config que continha campos inexistentes como password_hash
...
BEGIN
    ...
    -- Passo 2: Insere o novo record atômico guardando o histórico
