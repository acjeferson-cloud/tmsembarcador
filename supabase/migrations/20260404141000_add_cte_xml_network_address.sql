-- Adicionando a coluna cte_xml_network_address
ALTER TABLE public.erp_integration_config ADD COLUMN IF NOT EXISTS cte_xml_network_address VARCHAR(255);

-- Atualização da Função RPC para suportar a nova coluna cte_xml_network_address
