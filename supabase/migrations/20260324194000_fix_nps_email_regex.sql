-- Fix the NPS Queue Trigger Regex and Add Verbose UI Logging
-- Replaces \D with [^0-9] to guarantee cross-standard stripping of CNPJ punctuation.
-- Appends database execution steps to error_reason so the UI can display EXACTLY why it failed to find an email.
