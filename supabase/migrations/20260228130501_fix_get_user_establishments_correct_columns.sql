/*
  # Corrigir função get_user_establishments com nomes de colunas corretos

  1. Problema
    - Função usava nomes de colunas errados (fantasia, endereco, tracking_prefix)
    - Nomes corretos: nome_fantasia, logradouro, codigo (para tracking)
  
  2. Solução
    - Usar nomes de colunas corretos da tabela establishments
*/
