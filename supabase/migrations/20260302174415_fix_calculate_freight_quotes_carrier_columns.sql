/*
  # Corrigir coluna fantasia em calculate_freight_quotes

  1. Alterações
    - Corrigir referência de c.fantasia para c.nome_fantasia
    - Tabela carriers usa nome_fantasia, não fantasia
*/

-- Recriar função com a coluna correta
