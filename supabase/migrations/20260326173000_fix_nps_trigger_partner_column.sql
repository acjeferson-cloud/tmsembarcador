-- Fix NPS Queue Trigger by referencing the correct column `cpf_cnpj` in `business_partners`
-- The previous query referenced `cnpj` and `cpf` which caused a silent SQL exception.
